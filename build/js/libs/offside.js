    ...
    var offside = (function () {
        ...
        function initOffsideFactory( options ) {
            ...
            factorySettings = {
                ...
                slidingElementsSelector: '.offside-content',    // String: Default sliding elements selectors ('#foo, #bar')
            ...
            var globalClass = 'offside-js',                         // Global Offside classes namespace
                ...
                slidingElementsClass = 'offside-content',   // Class appended to sliding elements
